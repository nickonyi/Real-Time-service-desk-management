...
function App() {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'tickets' | 'reports'>('dashboard');
  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Real-time ticket tracking & reporting</p>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'tickets' && (
          <TicketList onTicketClick={setSelectedTicket} refreshTrigger={refreshTrigger} />
        )}
